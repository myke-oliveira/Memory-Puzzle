...
def getRandomizedBoard():
	...
	board = [[icons.pop() for y in range(BOARDHEIGHT)] for x in range(BOARDWIDTH)]
	return board
...
def startGameAnimation(board):
	...
	boxes = [(x, y) for y in range(BOARDHEIGHT) for x in range(BOARDWIDTH)]
